...
#define USART4_TX_PIN        GPIO_Pin_10 // PC10
#define USART4_RX_PIN        GPIO_Pin_11 // PC11
#define USART4_GPIO          GPIOC
#define USART4_GPIO_AF       GPIO_AF_7
#define USART4_TX_PINSOURCE  GPIO_PinSource10
#define USART4_RX_PINSOURCE  GPIO_PinSource11

#define USART5_TX_PIN        GPIO_Pin_12 // PC12
#define USART5_RX_PIN        GPIO_Pin_2 // PD2
#define USART5_GPIO_TX       GPIOC
#define USART5_GPIO_RX       GPIOD
#define USART5_GPIO_AF       GPIO_AF_5
#define USART5_TX_PINSOURCE  GPIO_PinSource12
#define USART5_RX_PINSOURCE  GPIO_PinSource2
